...
},{"./Analyzer/AnalyzerDateGetter.js":2,"./Analyzer/AnalyzerSubjectDescriptionGetter.js":3}],2:[function(require,module,exports){
...
},{"../Constants.js":4,"jquery":13}],4:[function(require,module,exports){
module.exports = {
  Analyzer: {
    SearchWords: {
...
},{"./Constants.js":4,"./Meeting.js":5}],7:[function(require,module,exports){
/**
...
// onMessageCallback is a function with one parameter that is the JSON results from the speech to text (STT) api
exports.handleMicrophone = function(token, model, mic, callback, onMessageCallback) {
  ...
  pubsub.publish('clearscreen');

  // Test out websocket
  var baseString = '';
  var baseJSON = '';

  pubsub.subscribe('showjson', function() {
...
},{"./socket":10,"jquery":13,"pubsub-js":14}],9:[function(require,module,exports){
{
   models: [
      {
...
var initSocket = exports.initSocket = function(options, onopen, onlistening, onmessage, onerror, onclose) {
  ...
  socket.onopen = function() {
    listening = false;
    pubsub.subscribe('hardsocketstop', function() {
      console.log('MICROPHONE: close.');
      socket.send(JSON.stringify({action:'stop'}));
      socket.close();
    });
    pubsub.subscribe('socketstop', function() {
      console.log('MICROPHONE: close.');
      socket.close();
    });
  ...
  socket.onclose = function(evt) {
    ...
    pubsub.unsubscribe('hardsocketstop');
    pubsub.unsubscribe('socketstop');
    onclose(evt);
  };
};

},{"./utils":11,"pubsub-js":14}],11:[function(require,module,exports){
var $ = require('jquery');
...
},{"./Speech-to-Text/Microphone":7,"./Speech-to-Text/handlemicrophone":8,"./Speech-to-Text/models.JSON":9,"./Speech-to-Text/utils":11,"jquery":13,"pubsub-js":14}],13:[function(require,module,exports){
/*!
